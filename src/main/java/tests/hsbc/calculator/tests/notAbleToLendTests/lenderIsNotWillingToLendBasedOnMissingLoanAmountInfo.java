...
public class lenderIsNotWillingToLendBasedOnMissingLoanAmountInfo extends pageMethods {

    String test_case = "TC7";

    /**
     * This test references to the test case "TC7" on the spreadsheet here:
